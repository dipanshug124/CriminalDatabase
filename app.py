...
def addpage():
    ...
    if form.validate_on_submit():
        criminals = Criminal(photo=form.img.data.filename, fingerprint=form.fingerprintImg.data.filename,  Name=form.Name.data, gender=form.gender.data, crime=form.crime.data, inJail=form.inJail.data, country=form.country.data)
